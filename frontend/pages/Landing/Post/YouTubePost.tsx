// frontend/pages/Landing/Post/YouTubePost.tsx
import React, { useState } from "react";
import styles from "../../../styles/LandingCSS/PostCSS/YouTubePost.module.css";
import {
  FaYoutube,
  FaLink,
  FaPlus,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.response?.status === 401) {
        // You can use router.push('/Auth/login') if you import useRouter
